"""Researcher agent -- LangGraph implementation.

Same Agent Card and skill as the a2a/ version. The difference is internal:
instead of a single Anthropic SDK call, the work runs through a LangGraph
StateGraph. Peers in the swarm see no difference -- the A2A transport is identical.
"""
...
if __name__ == "__main__":
    ...
    print(f"[Researcher/LangGraph] listening on {url}")
    print(f"[Researcher/LangGraph] card at {url}.well-known/agent-card.json")
