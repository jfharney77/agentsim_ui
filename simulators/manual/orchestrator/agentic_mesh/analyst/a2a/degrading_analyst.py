"""Degrading Analyst — A2A version for orchestrator topology.
...
if __name__ == "__main__":
    ...
    print(f"[Degrading Analysis Worker/A2A] listening on {url}")
    print(f"[Degrading Analysis Worker/A2A] card at {url}.well-known/agent-card.json")
    print(f"[Degrading Analysis Worker/A2A] MAST failure injection ACTIVE")
